...
- [ ] Capture more ref variants as the same ref
  ...
  If a roam-ref exists like =//www.website.com=, allow counting =//www.website.com?key=val&key2=val2#hash= as a reflink to the same, unless the latter has a roam-ref of its own.
