...
#+begin_quote
ASIDE: To be clear, this never generates new IDs.  That's your own business.  This only edits :BACKLINKS: properties, and no backlink will appear from places where there was no ID among any outline ancestor.
#+end_quote
...
NOTE:  People who /don't/ use visual-line-mode or other soft-wrap modes may not find this solution very scalable, since Org properties are always a single logical line.
