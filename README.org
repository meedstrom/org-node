...
3. /then/ upgrade to the latest version on [[https://github.com/meedstrom/org-node/branches][main]].

Or just check that you're not using any of [[https://github.com/meedstrom/org-node/blob/v1.9/org-node-changes.el][these aliases]].
...
# 4. User option =org-node-backlink-aggressive= now has the inverted meaning, and named =org-node-backlink-lazy=.  It is now aggressive by default.
