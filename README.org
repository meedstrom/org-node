...
(NB: if you don't know what is =ROAM_EXCLUDE=, you can omit that clause)
...
However, nodes in isolation do still have inherited tags.  So you can exploit that, or the file name or outline path.

Really, filename!  Even though a big selling point of IDs is that you avoid depending on filenames, it's often pragmatic to let up on principles a bit :-)  It works well for me to filter out any file or directory that happens to contain "archive" in the name:
...
That last optional functionality may be a bit confusing if I explain it -- better you try it and see if you like.
...
You want to customize how the nodes look in the minibuffer?  It's down to =org-node-affixation-fn=:
...
Just in case---
- 2024-10-05 released org-node v1.5 and fakeroam v1.3
- 2024-10-24 released org-node v1.6 and fakeroam v1.4
- 2024-10-27 released org-node v1.7 and fakeroam v1.5
- 2024-11-14 released org-node v1.8
- 2024-11-18 released org-node v1.9+ and fakeroam v1.6+
