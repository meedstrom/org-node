...
Version 2.0 is out, with two new features:
...
The main reason for bumping to 2.0 is culling the crop of aliases that have built up after renames, as they clutter ~C-h f~ output.
