...
- Rename many functions and variables
  - Don't worry, you'll get warning messages for each old name used in your initfiles
...
# *** Completion-at-point
# Not sure how/when people use =org-roam-completion-everywhere=, but it's popular so here you go for an equivalent.
