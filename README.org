...
It will be the new default behavior, because:

1. You never know when you might want to reference timestamps or other extra info, that is now trivial to store but hard to reconstruct later.
2. It's more scalable for people who do not enable =visual-line-mode=
