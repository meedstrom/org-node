...
2. If we've recorded the backlinks inside the subtrees, the cache builder can just grab them while it grabs all the other info, leaving almost zero work to do.
