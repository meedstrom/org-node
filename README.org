...
* News for v3 :export:
A lot of code has been spun into a new library https://github.com/meedstrom/indexed, now a dependency.  Reduces codebase by 25%.  This may allow other projects to create interesting stuff without org-node.
...
Also you'll get messages about it, but enable two modes before =org-node-cache-mode=:
