* org-node
** News [2024-05-01]
- So it turns out this package is much slower on a vanilla Emacs config than on my personal Doom Emacs config, somehow!  The command =org-node-reset= takes me 1 second but in `emacs -Q` it takes 60 seconds!  I'm looking into why.
