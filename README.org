...
Already included is a definition that approximates the org-roam-dailies defaults, but I encourage you to override it to suit your tastes.  [[https://github.com/meedstrom/org-node/wiki/Configuring-series][Wiki]].

You may be taken aback that defining a new series requires writing 5 lambdas, but once you get the hang of it, you can often reuse those lambdas.  A future version will bring convenient wrappers.
