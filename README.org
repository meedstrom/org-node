...
If you're new to these concepts, fear not.  The main things for day-to-day operation are two commands: the "find" and the "insert-link" command.
...
Final tip for the newbie: you create a new node through these same commands---just type the name of a node that doesn't exist!
