...
- =org-node-extract-subtree= instead of =org-roam-extract-subtree=

Check out more under [[https://github.com/meedstrom/org-node?tab=readme-ov-file#commands][Commands]].  Enjoy!

I'm guessing you also want [[https://github.com/meedstrom/org-node?tab=readme-ov-file#backlink-solution-1-org-roam-buffer][org-roam-buffer backlinks]].  See that section.
