...
Users of [[https://github.com/toshism/org-super-links][org-super-links]] are already familiar with this concept, but they use a /drawer/ called :BACKLINKS:, not a /property line/.

I am looking into enabling that possibility as well.  For now, if you are such an user, forget all the above and instead continue to rely on org-super-links:

#+begin_src elisp
(add-hook 'org-node-insert-link-hook #'org-node-convert-link-to-super)
#+end_src

I /think/ that should work. Totally untested, let me know!
