...
Either revert that with the following snippet, or simply delete the "~/.emacs.d/org-roam.db" file if [[https://github.com/meedstrom/org-node-fakeroam][Fakeroam]] can cover your needs.
