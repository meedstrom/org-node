...
* News
** Breaking changes [2024-09-26]
- User option =org-node-series-defs= now ships an empty default value. Check the [[https://github.com/meedstrom/org-node/wiki/Configuring-series][wiki]] to configure it.

  This was done for several reasons, not the least being that people actually use it :-)  I do not want to support what was meant to be an example, and it's cleaner this way.

* Background
** What's all this

I like [[https://github.com/org-roam/org-roam][org-roam]] but found it too slow, so I made [[https://github.com/meedstrom/quickroam][quickroam]].  And that idea spun off into this package, a standalone thing.  By accident, I believe it's also easier to pick up than org-roam.
