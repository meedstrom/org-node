...
If you're happy with the result, and don't need =roam:= links, you can disable =org-roam-db-autosync-mode= entirely in favour of the slimmer =M-x org-node-roam-redisplay-mode=.  As an init snippet:
...
# *** Completion-at-point
# Not sure how/why people use =org-roam-completion-everywhere=, but it's popular so here you go for an equivalent.
