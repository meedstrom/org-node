* org-node
** News [2024-05-01]
- So it turns out this package takes tens of seconds to scan files on a vanilla Emacs config!  On my Emacs config, somehow, it just takes one second... I'm looking into why.
