...
If you are an org-roam user, you'll want the [[https://github.com/meedstrom/org-node-fakeroam][org-node-fakeroam]] module as well.  Check out [[https://github.com/meedstrom/org-node-fakeroam][its README]] to make org-node *work with org-roam side-by-side!*
