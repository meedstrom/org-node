...
I used to lose things I had written, buried under some forgotten heading in a forgotten file in a forgotten directory.  The org-roam method let me *find and build on my own work*, instead of repeating [[https://en.wikipedia.org/wiki/Cryptomnesia][cryptomnesia]] on square one forever.
