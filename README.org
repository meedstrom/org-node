...
- org-node is now multi-threaded, speeding it up even more!
  ...
  If anything breaks, try nulling the user option =org-node-perf-multicore=, or revert versions by adding :branch "before-refactor" to the Straight package expression.
